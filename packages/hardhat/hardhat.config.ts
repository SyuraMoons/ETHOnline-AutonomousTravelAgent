...
// Forking the live Hedera network is opt-in (npm run hardhat:chain / npm run hardhat:fork set HEDERA_FORKING=true).
// Contracts that are pure EVM (no HTS/HSS precompiles) can run unit tests and local compiles
// hermetically without forking. Enable forking only when you need live Hedera system contracts.
