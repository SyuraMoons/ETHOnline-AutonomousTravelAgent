...
// to show. Either input here — the bar or a chip — ends up as a brief the agent
// answers, and its answer is what opens the results.
...
export function SearchLanding() {
  ...
  return (
    <div className="mx-auto flex w-full max-w-[760px] flex-col gap-8 px-6 py-12">
