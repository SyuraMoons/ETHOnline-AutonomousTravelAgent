...
import type { SearchResult } from "@autovoyage/contracts";

const __dirname = path.dirname(fileURLToPath(import.meta.url));

// Repo root: src/lib -> src -> supplier -> apps -> repo root.
...
// cache as the paid search response instead of always returning 402.
